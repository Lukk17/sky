...
| `/offer/swagger-ui.html`, `/offer/swagger-ui`, `/offer/v3/api-docs` | `OFFER_URI` | `http://localhost:5552` |
| `/booking/swagger-ui.html`, `/booking/swagger-ui`, `/booking/v3/api-docs` | `BOOKING_URI` | `http://localhost:5555` |
| `/msg/swagger-ui.html`, `/msg/swagger-ui`, `/msg/v3/api-docs` | `MESSAGE_URI` | `http://localhost:5553` |
