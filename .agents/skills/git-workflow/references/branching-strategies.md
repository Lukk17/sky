...
The three strategies in full, with the shape of each and the rules that go with it, plus the table for choosing
between them. Load this file when picking or changing a strategy for a repository.
