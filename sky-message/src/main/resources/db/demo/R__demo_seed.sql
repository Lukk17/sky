...
VALUES (1, 'Hi! I am interested in booking the Sopot Beach Hotel. Is it available in July?', now(), true,
        'owner@sky.dev', 'user@sky.dev'),
       (2, 'Hello! Yes, the Sopot Beach Hotel is available in July. I have reserved it for you.', now(), true,
