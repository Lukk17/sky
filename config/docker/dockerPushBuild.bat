...
docker tag lukk17/sky-booking lukk17/sky-booking:v1.0.1-candidate-x00
docker tag lukk17/sky-message lukk17/sky-message:v1.0.1-candidate-x00
::docker tag lukk17/sky-notify lukk17/sky-notify:v1.0.0
docker tag lukk17/sky-offer lukk17/sky-offer:v1.0.1-candidate-x02

docker push lukk17/sky-booking:v1.0.1-candidate-x00
docker push lukk17/sky-message:v1.0.1-candidate-x00
::docker push lukk17/sky-notify:v1.0.0
docker push lukk17/sky-offer:v1.0.1-candidate-x02
