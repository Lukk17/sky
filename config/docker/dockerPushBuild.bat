...
docker tag lukk17/sky-booking lukk17/sky-booking:v1.0.1
docker tag lukk17/sky-message lukk17/sky-message:v1.0.1
docker tag lukk17/sky-notify lukk17/sky-notify:v1.0.1
docker tag lukk17/sky-offer lukk17/sky-offer:v1.0.1

docker push lukk17/sky-booking:v1.0.1
docker push lukk17/sky-message:v1.0.1
docker push lukk17/sky-notify:v1.0.1
docker push lukk17/sky-offer:v1.0.1
