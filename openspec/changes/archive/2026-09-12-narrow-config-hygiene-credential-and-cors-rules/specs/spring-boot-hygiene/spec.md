...
- **WHEN** an operator lists every cross-origin value this repository ships for a service or for an ingress in front of one, covering the three REST services, the sky-notify WebSocket allow-list and the ingress annotations in the Helm values
